...
export const getAllTasks = () => dispatch => {
  axios.get(`https://api.cosmicjs.com/v1/c1dd4310-a4a2-11e7-8527-2f7edadb33c5/object-type/tasks`)
    .then((response) => {
...
export const postNewTask = (task) => dispatch => {
  ...
  axios.post(`https://api.cosmicjs.com/v1/c1dd4310-a4a2-11e7-8527-2f7edadb33c5/add-object`, {type_slug: "tasks", title: task, content: "New Task",
    metafields: [
      {
        title: "Is Complete",
        key: "is_complete",
...
export const putChangeStatus = (task, bool) => (dispatch) => {
  ...
  axios.put(`https://api.cosmicjs.com/v1/c1dd4310-a4a2-11e7-8527-2f7edadb33c5/edit-object`, {slug: task.slug,
    metafields: [
      {
        title: "Is Complete",
        key: "is_complete",
